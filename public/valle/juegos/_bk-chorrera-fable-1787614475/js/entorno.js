...
export function crearEntorno(THREE, pista, cfg = {}) {
  ...
  // `default` conserva el circuito y ambiente base intactos.
  const mundoChorrera = typeof location !== 'undefined'
    && (new URLSearchParams(location.search).get('mundo') === 'chorrera'
