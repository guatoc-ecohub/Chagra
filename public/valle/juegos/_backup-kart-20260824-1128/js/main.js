...
let seleccion = 0;
// QA visual reproducible: permite arrancar directamente con un vehículo
// abierto (`?vehiculo=carretilla`) sin cambiar el roster ni el flujo normal.
const vehiculoDirecto = typeof location !== 'undefined'
  ? new URLSearchParams(location.search).get('vehiculo') : null;
const indiceVehiculoDirecto = VEHICULOS.findIndex((v) => v.id === vehiculoDirecto);
if (indiceVehiculoDirecto >= 0) seleccion = indiceVehiculoDirecto;
