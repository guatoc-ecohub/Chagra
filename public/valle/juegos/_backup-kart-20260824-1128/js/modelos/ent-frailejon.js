...
const FRASE_COMERCIAL = '¡EL PÁRAMO NO TE DEJA PASAR!';
...
export function crearEntFrailejonRescatador(THREE, opts = {}) {
  ...
  function actualizar(dt) {
    ...
    grupo.position.y = baseY + Math.sin(fase * 8) * 0.07;
    brazos.children.forEach((brazo, i) => {
      const lado = i === 0 ? -1 : 1;
      brazo.rotation.z = lado * (-0.82 + Math.sin(fase * 15 + i) * 0.12) + golpe * 0.2;
    });
