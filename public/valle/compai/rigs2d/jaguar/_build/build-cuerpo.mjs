...
for (let y = 0; y < H; y++) for (let x = 0; x < W; x++) {
  ...
  // El borde exterior de la garra blanca estaba fuera del corte anterior:
  // eran píxeles reales de la lámina, pero al quedar en el cuerpo se volvían
  // una mancha fija cuando la pieza de la pata giraba. La pata ya los recoge
  // con su curva medida en build-patas.mjs.
  if (x < 128 && y >= 350 && y < 388) m = 0;
