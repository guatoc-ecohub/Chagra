/**
 * crop-grilla — recortes de oso.png con grilla de coordenadas de LÁMINA
 * superpuesta (líneas cada 20px, etiquetas cada 40px) para medir cortes a ojo.
 * Mismo método del jaguar (crop.mjs) + grilla etiquetada.
 */
...
const crops = [
  { name: 'piernas',      left: 110, top: 340, width: 380, height: 250, scale: 2 },
  { name: 'pierna-izq',   left: 120, top: 360, width: 170, height: 230, scale: 3 },
  { name: 'pierna-der',   left: 300, top: 360, width: 190, height: 220, scale: 3 },
  { name: 'brazo-baston', left: 380, top: 130, width: 235, height: 380, scale: 2 },
  { name: 'zarpa-palo',   left: 460, top: 220, width: 130, height: 140, scale: 4 },
  { name: 'hombro-der',   left: 380, top: 140, width: 130, height: 140, scale: 3 },
  { name: 'roca',         left: 0,   top: 430, width: 615, height: 200, scale: 1 },
  { name: 'torso',        left: 130, top: 140, width: 360, height: 300, scale: 2 },
];
