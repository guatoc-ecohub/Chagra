...
export function bakearArbolMasa(clave, { detalle = 'lod', tono = '#35612d', claro, oscuro, seed = null, lejos = false } = {}) {
  ...
  const { grupo, matCards, matNucleo } = crearCopaMasa(THREE, {
    ...
    tamCard: lejos ? 2.4 : 1.6,
    maxCards: lejos ? 90 : 260,
    ...
    // una esfera facetada.
    nucleoOpts: lejos
      ? { segs: [5, 4], encoger: 0.88, rugosidad: 0.38, sombra: 0.48 }
      : { segs: [8, 6], encoger: 0.88, rugosidad: 0.38, sombra: 0.48 },
    texOpts: { medio: tono, oscuro: estilo(sombra), claro: estilo(luz), hojas: lejos ? 300 : 420, alargue: 2.0 },
  });
