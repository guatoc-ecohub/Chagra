...
function makeKartWaterfalls(scene, { pista, seed = 20260811 } = {}) {
  ...
  const CAIDAS = [
    { fA: 0.0815, fB: 0.0850, lado: -1, ancho: 3.6, saltos: 1, cal: 'baja', gotas: 12, pozo: 2.6, muro: 1 },   // beat 1
    { fA: 0.1315, fB: 0.1350, lado: 1, ancho: 3.2, saltos: 1, cal: 'baja', gotas: 10, pozo: 2.2, muro: 1 },    // beat 2a
    { fA: 0.1545, fB: 0.1580, lado: 1, ancho: 3.4, saltos: 1, cal: 'baja', gotas: 10, pozo: 2.4 },             // beat 2b
    { fA: 0.2065, fB: 0.2110, lado: -1, ancho: 8.0, saltos: 2, cal: 'alta', gotas: 48, pozo: 3.0, muro: 1 },   // beat 3 — GRAN SALTO
    { fA: 0.2665, fB: 0.2700, lado: 1, ancho: 3.4, saltos: 1, cal: 'baja', gotas: 12, pozo: 2.5, muro: 1 },    // beat 4
    { fA: 0.3165, fB: 0.3200, lado: -1, ancho: 3.4, saltos: 1, cal: 'baja', gotas: 12, pozo: 2.5, muro: 1 },   // beat 5
    { fA: 0.4000, fB: 0.4040, lado: 1, ancho: 2.6, saltos: 1, cal: 'baja', gotas: 8, pozo: 1.8 },     // diag 1
    { fA: 0.4360, fB: 0.4400, lado: 1, ancho: 2.6, saltos: 1, cal: 'baja', gotas: 8, pozo: 1.8 },     // diag 2
    { fA: 0.4885, fB: 0.4930, lado: -1, ancho: 12.5, saltos: 1, cal: 'alta', gotas: 62, pozo: 4.2, anchoFinal: 1.25, muro: 1 }, // beat 7 — CLÍMAX ANCHO
  ];
  ...
  // ── bruma volumétrica: el golpe del gran salto y del clímax respiran ──────
  const gran = kartPoint(pista, 0.218, 0);
  const climax = kartPoint(pista, 0.505, 0);
  anclasBruma.push(
    { x: gran.x, y: gran.q.y + 1.5, z: gran.z },
    { x: climax.x, y: climax.q.y + 2, z: climax.z },
  );
