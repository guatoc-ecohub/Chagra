/**
 * ez-tree — Trellis (espaldera opcional para guiar el crecimiento de ramas).
 *
 * Fuente: dgreenheck/ez-tree, MIT License. Copyright (c) 2024 Daniel Greenheck.
 * Puerto r167→r160 sin cambios: CylinderGeometry/MeshStandardMaterial/Group
 * son estables entre revisiones. Ninguna de las 6 especies iniciales la usa
 * (todas `trellis.enabled:false`); se deja disponible para maracuyá/uva/tomate
 * de enrame más adelante.
 */
