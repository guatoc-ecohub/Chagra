...
export function crearCamara(THREE, camara, cfg = {}) {
  ...
  // corte franco: tras un teletransporte (portal) la cámara NO debe viajar
  // por todo el mapa persiguiendo al kart — reaparece detrás en el frame.
  function cortar() { curPos = null; }

  return { actualizar, sacudir, cam, setModo, setReducedMotion, reencuadrar, cortar };
}
