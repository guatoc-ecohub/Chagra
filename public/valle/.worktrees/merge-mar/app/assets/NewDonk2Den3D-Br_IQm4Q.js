...
`;function k({onBack:e}){let[t]=(0,l.useState)(()=>typeof window<`u`&&!!window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches),[n,r]=(0,l.useState)(()=>typeof window<`u`&&new URLSearchParams(window.location.search).get(`nd`)===`2d`?`juego2d`:`valle3d`),a=(0,l.useCallback)(()=>r(`acercando`),[]),o=(0,l.useCallback)(()=>r(`saliendo`),[]),s=(0,l.useCallback)(e=>{r(e===`acercando`?`juego2d`:`valle3d`)},[]),d=n===`valle3d`,f=n===`juego2d`,p=n===`acercando`||n===`saliendo`;return(0,u.jsxs)(`section`,{className:`nd-raiz`,"data-fase":n,"aria-label":`Mural 2D dentro de la finca 3D: la cámara se aplana contra el plano para jugar en 2D con el 3D alrededor`,children:[(0,u.jsx)(`style`,{children:O}),(0,u.jsxs)(i,{dpr:[1,1.5],gl:{antialias:!0,powerPreference:`high-performance`},camera:{position:m.pos.toArray(),fov:m.fov},children:[(0,u.jsx)(`color`,{attach:`background`,args:[g.cielo]}),(0,u.jsx)(`fog`,{attach:`fog`,args:[g.niebla,13,34]}),(0,u.jsx)(c,{fase:n,poseValle:m,poseBoca:h,reducedMotion:t,onLlegada:s}),(0,u.jsx)(C,{reducedMotion:t}),(0,u.jsx)(D,{fase:n,reducedMotion:t,onEntrar:a})]}),(0,u.jsxs)(`div`,{className:`nd-chrome`,children:[d&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`h2`,{className:`nd-titulo`,children:`El mural de la finca`}),(0,u.jsx)(`p`,{className:`nd-sub`,children:`Un plano 2D vive dentro del valle 3D — como los murales de New Donk`}),e&&(0,u.jsx)(`button`,{type:`button`,className:`nd-volver`,onClick:e,children:`← Salir`}),(0,u.jsx)(`button`,{type:`button`,className:`nd-boton`,onClick:a,children:`Toque para entrar`})]}),f&&(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`p`,{className:`nd-pista`,children:`Está en el plano 2D — el valle sigue ahí, en los bordes`}),(0,u.jsx)(`button`,{type:`button`,className:`nd-boton`,onClick:o,children:`Volver al valle 3D`})]}),p&&(0,u.jsx)(`p`,{className:`nd-pista`,children:n===`acercando`?`Entrando al mural…`:`Volviendo al valle…`})]})]})}export{k as default};