...
export function bakearArbolMasa(clave, { detalle = 'lod', tono = '#35612d', claro, oscuro, seed = null } = {}) {
  ...
  const { grupo, matCards, matNucleo } = crearCopaMasa(THREE, {
    ...
    // una esfera facetada.
    nucleoOpts: { segs: [8, 6], encoger: 0.88, rugosidad: 0.38, sombra: 0.48 },
    texOpts: { medio: tono, oscuro: estilo(sombra), claro: estilo(luz), hojas: 420, alargue: 2.0 },
  });
