...
`,f=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2;function p(e,t){if(Math.abs(e.fov-t)<.01)return;let n=.5*e.getFilmHeight()/Math.tan(r.degToRad(t)/2);e.setFocalLength(n)}function m({fase:e,poseValle:t,poseBoca:n,reducedMotion:r=!1,viajeSegundos:c=1.25,onLlegada:l}){let{camera:u}=i(),d=(0,s.useRef)({fasePrevia:null,t:0,avisado:!1}),m=(0,s.useRef)(l),h=(0,s.useRef)(new a);return(0,s.useEffect)(()=>{m.current=l}),o((i,a)=>{let o=d.current;o.fasePrevia!==e&&(o.fasePrevia=e,o.t=0,o.avisado=!1);let s=e===`acercando`;if(s||e===`saliendo`){o.t=Math.min(1,o.t+(r?1:Math.min(a,.05)/c));let i=f(o.t),l=s?t:n,d=s?n:t;u.position.lerpVectors(l.pos,d.pos,i),h.current.lerpVectors(l.mira,d.mira,i),u.lookAt(h.current);let g=s?i*i:Math.sqrt(i);p(u,l.fov+(d.fov-l.fov)*g),o.t>=1&&!o.avisado&&(o.avisado=!0,m.current?.(e));return}if(e===`valle3d`){let e=r?0:i.clock.elapsedTime;u.position.set(t.pos.x+Math.sin(e*.16)*.4,t.pos.y+Math.sin(e*.11)*.16,t.pos.z+Math.cos(e*.13)*.32),u.lookAt(t.mira),p(u,t.fov);return}u.position.copy(n.pos),u.lookAt(n.mira),p(u,n.fov)}),null}function h({fase:e,irisMs:t=640,className:n=``,children:r}){let i=e===`iris-abre`?`abre`:e===`iris-cierra`?`cierra`:`no`;return(0,u.jsxs)(`div`,{className:`tunel-odyssey__iris ${n}`.trim(),"data-iris":i,style:{"--tunel-odyssey-iris-ms":`${t}ms`},children:[(0,u.jsx)(`style`,{children:d}),r]})}export{h as n,l as r,m as t};