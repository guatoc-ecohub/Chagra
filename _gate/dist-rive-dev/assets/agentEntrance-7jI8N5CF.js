...
.${e} {
  animation: chagra-agent-enter-kf 460ms cubic-bezier(0.22, 0.61, 0.36, 1) both;
  transform-origin: 50% 0%;
  will-change: opacity, transform;
}
@media (prefers-reduced-motion: reduce) {
  .${e} { animation: none !important; }
}
`,n=`
  .as-bar {
...
`;function i(){return typeof window<`u`&&typeof window.matchMedia==`function`?window.matchMedia(`(prefers-reduced-motion: reduce)`).matches:!1}function a(t=i()){return t?``:e}export{a as i,t as n,r,n as t};