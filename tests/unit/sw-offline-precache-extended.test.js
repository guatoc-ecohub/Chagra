 ...
 *   3. Arranque en frío sin red: shell + RAG grounding + mapa
 *   4. Mock de Cache API para cobertura completa
 *
 * Usa el mismo sandbox (loadSW) del test original para cargar el SW real
 * de public/sw.js y verificar el contrato.
 */
