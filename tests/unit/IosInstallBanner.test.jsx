...
describe('IosInstallBanner', () => {
  ...
  it('muestra el banner en iOS Safari (no standalone, no dismissed)', () => {
    ...
    expect(screen.getByText(/Instale Chagra/i)).toBeInTheDocument();
    expect(screen.getByText(/Toque el botón Compartir/i)).toBeInTheDocument();
  });

  it('NO muestra el banner en Desktop Chrome', () => {
    setUserAgent(DESKTOP_UA);
    render(<IosInstallBanner />);
    expect(screen.queryByText(/Instale Chagra/i)).not.toBeInTheDocument();
  });
