...
describe('CONTROL POSITIVO — los seis casos del card 095 sobre dev', () => {
  ...
  it('caso 6 · láminas-viva (094): las seis salieron del árbol que audita el build', () => {
    ...
    for (const nombre of ['ChivitoPunkLaminaViva.jsx', 'JaguarLaminaViva.jsx', 'LuciernagaLaminaViva.jsx', 'OsoBastonLaminaViva.jsx', 'ZariguyaGeminiLaminaViva.jsx', 'ZariguyaLaminaViva.jsx']) {
      expect(existsSync(join(ROOT, 'src/visual/creatures/_archivo', nombre)), nombre).toBe(true);
    }
  });
