 ...
 *   · El tiempo     → 'clima_boletin' (la página del tiempo: escena viva +
 *                     dato real con fuente; spec 2026-09-06-unificar-2d-clima).
 *                     'hoy_finca' (su día en la finca) sigue en «Toda mi finca».
 *   · Vender        → 'mercado'.
 *   · Aprender      → 'aprende'.
