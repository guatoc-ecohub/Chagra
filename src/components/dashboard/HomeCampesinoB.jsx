    ...
    <div className="cb-home">
      ...
      <main id="contenido-campesino" className="cb-main">
        ...
        <section className="cb-bottom-grid" aria-label="Resumen y mundos de su finca">
          ...
          <article className="cb-worlds-card"><div className="cb-worlds-heading"><div><p className="cb-eyebrow">SUS MUNDOS</p><h2>Entre por donde lo necesite</h2></div><Mountain size={30} aria-hidden="true" /></div><div className="cb-world-links"><button type="button" onClick={() => go('mundo', { mundo: 'semillero' })}><span>🌱</span><b>Sembrar</b><small>semillero</small><ChevronRight size={17} /></button><button type="button" onClick={() => go('mundo', { mundo: 'sanidad' })}><span>🛡️</span><b>Cuidar</b><small>sanidad</small><ChevronRight size={17} /></button><button type="button" onClick={() => go('mundo', { mundo: 'mercado' })}><span>🧺</span><b>Vender</b><small>mercado</small><ChevronRight size={17} /></button></div></article>
        </section>
