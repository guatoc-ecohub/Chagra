/**
 * ChagraAgentAvatar{Jaguar,OsoBaston,Luciernaga} — ítem #8 del GAP compAI
 * (2026-08-13, "elenco unificado"): estos tres ya tenían cuerpo 2.5D dibujado
 * (Jaguar.jsx/OsoBaston.jsx/Luciernaga.jsx, con tests propios de render) y ya
 * estaban `enPWA:true` en `compai/nucleo/elenco.js` (#96) desde el
 * 2026-08-11, pero ningún selector los exponía. Estos wrappers cierran ese
 * hueco — mismo contrato que ChagraAgentAvatarZariguya (state/size/withLabel/
 * onClick/onDoubleClick/glow/className/ariaLabel).
 */
