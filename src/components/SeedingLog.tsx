...
export default function SeedingLog({ onBack, onSave }: SeedingLogProps) {
    ...
    if (isRecording) {
      ...
      if ('geolocation' in navigator) {
        watchIdRef.current = navigator.geolocation.watchPosition(
          (pos) =>
            setCoordinates((prev) => [...prev, [pos.coords.longitude, pos.coords.latitude]]),
      ...
      const payload = {
        data: {
          ...
          attributes: {
            ...
            ...(coordinates.length >= 3 && firstCoord
              ? {
                  geometry: {
                    type: 'Polygon',
