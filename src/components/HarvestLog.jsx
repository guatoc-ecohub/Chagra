...
export default function HarvestLog({ onBack, onSave }) {
  ...
  /** @type {{date?:boolean; subArea?:boolean; product?:boolean; quantity?:boolean; [key:string]:any}} */
  const [touched, setTouched] = useState({});

  // Bug 069.10 — validación inline (subArea, product, quantity, date)
  /** @type {{date?:string; subArea?:string; product?:string; quantity?:string; [key:string]:any}} */
  const errors = useMemo(() => {
    const e = /** @type {{date?:string; subArea?:string; product?:string; quantity?:string}} */({});
