...
const HEALTH_STATUSES = ['Sano', 'En recuperación', 'Plaga detectada'];
...
export default function PlantAssetLog({ onBack, onSave }: PlantAssetLogProps) {
