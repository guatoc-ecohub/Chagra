...
export const VIDA_REPERTORIO = {
  ...
  /* Oxypogon guerinii — el chivito de páramo en su MOOD punk (la capa de
     actuación, no un bicho aparte): colibrí inquieto como el de arriba, pero
     su firma no es acicalarse — es el HEADBANG (la cresta mohawk azota con la
     testa entera) y APUNTAR en el aire con el lápiz (el escribano de páramo).
     El 70% es identidad serena; este 30% es la actuación punk. Activa las
     keyframes `clv-rockea-*`/`clv-apunta-*` (chivitoLamina.css) vía data-vida
     — sin este repertorio, `useVidaIdle('chivito-punk')` no gesticula nunca. */
  'chivito-punk': {
