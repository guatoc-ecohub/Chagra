...
export const OSO_BASTON_FIRMA = Object.freeze({
  rasgos: Object.freeze([
    ...
    Object.freeze({
      ...
      porque: 'Los otros oeres de la casa van sentados o en mole de cuatro apoyos; el del bastón es el ÚNICO que se para como excursionista. La bota ensancha el pie en la silueta — se lee aunque sea una mancha negra.',
    }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      porque: 'Completa el trío de marcas crema de la especie (anteojos, hocico, pecho). En silueta el pecho abombado del erguido la erestiene: el bulto pectoral existe aunque la luna no se vea.',
    }),
  ]),
