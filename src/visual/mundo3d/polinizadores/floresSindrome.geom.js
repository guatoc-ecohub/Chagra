 ...
 */
export function geomCampana({ q = 1, hembra = false } = {}, seed = 3) {
 ...
 */
export function geomPlato({ q = 1 } = {}, seed = 4) {
 ...
 */
export function geomCopa({ q = 1 } = {}, seed = 6) {
 ...
 */
export function geomPasiflora({ q = 1 } = {}, seed = 7) {
