 ...
 * otro día—, pero la diferencia es enorme y es GRATIS. Aquí esa diferencia no está
...
export default function AmenazaVeneno({
  ...
  // Ref-escape-hatch (CamaraDirector/EscenaBoveda/Valle3D): el material del
  // useMemo se muta cada frame (opacity) vía ref, no reasignando la variable
  ...
  useFrame((state, dtCrudo) => {
    ...
    matRef.current.opacity = 0.34 * entrada * salida;
