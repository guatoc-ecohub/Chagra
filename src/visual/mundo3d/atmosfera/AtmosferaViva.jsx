...
function Luciernagas({ maximo, objetivo, reducedMotion }) {
  ...
  // Sincronizado DESPUÉS del render (no durante): el useFrame de abajo lo lee
  // fuera del ciclo de render, así que no hace falta useLayoutEffect.
  useEffect(() => { objetivoRef.current = objetivo; });
