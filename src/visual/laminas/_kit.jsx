 ...
 * @param {Object} props
 * @param {number|string} props.x
 * @param {number|string} props.y
 * @param {number|string} props.tx
 * @param {number|string} props.ty
 * @param {string} props.texto
 * @param {string|null} [props.sub]
 * @param {'start'|'middle'|'end'} [props.anchor]
 * @param {number} [props.stage]
 */
