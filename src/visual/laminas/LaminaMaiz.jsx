 ...
 * @param {{x: string|number, y: string|number, tx: string|number, ty: string|number,
 *          texto: string, sub?: string|null, anchor?: 'start'|'middle'|'end'}} props */
function Rotulo({ x, y, tx, ty, texto, sub = null, anchor = 'start' }) {
  return (
    <g>
      ...
      {/* Number(): con y string ("150" + 13 = "15013") el sub caía fuera del lienzo */}
      {sub && (
        <text
          x={x}
          y={Number(y) + 13}
