...
function Rotulo({ tx, ty, anchor = 'start', texto, nota = null, guia }) {
  ...
  return (
    <g>
      ...
      <text x={tx} y={ty} textAnchor={ta} fontSize="11" fontWeight="700" fill="#4f3a20" letterSpacing="0.02em">
        {texto}
      </text>
      {nota && (
        <text x={tx} y={Number(ty) + 11} textAnchor={ta} fontSize="8.5" fontStyle="italic" fill="#8a7350">
          {nota}
        </text>
      )}
    </g>
