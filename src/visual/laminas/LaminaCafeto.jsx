 ...
 * @param {{tx: string|number, ty: string|number, anchor?: 'start'|'middle'|'end',
 *          texto: string, nota?: string,
 *          guia?: {d: string, px: string|number, py: string|number}}} props */
function Rotulo({ tx, ty, anchor = 'start', texto, nota, guia }) {
  return (
    <g>
      ...
      {/* Number(): con ty string ("150" + 11 = "15011") la nota caía fuera del lienzo */}
      {nota && (
        <text x={tx} y={Number(ty) + 11} textAnchor={anchor} fontSize="8.5" fontStyle="italic" fill="#8a7350">
          {nota}
        </text>
      )}
    </g>
