...
/* Los labels del REGISTRO (nombre/clave/origen) son metadata del catálogo de la
   librería, dev-facing (vitrina + descubribilidad), no copy de UI; no van a
   src/config/messages.js (ADR-050). Mismo patrón que src/data/*. */
/*
