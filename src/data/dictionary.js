...
export const DICTIONARY = [
  ...
  // ===========================================================================
  {
    ...
    contexto_cultural: 'El nombre Chagra es préstamo respetuoso de comunidades amazónicas. La app NO se adueña del concepto, lo reconoce explícitamente. La fitonimia indígena de cada planta queda en el catálogo (queue/058). El sistema que la app representa es agroecológico-relacional, lo opuesto al monocultivo industrial que domina el agronegocio.',
...

  {
    ...
    contexto_cultural: 'Acción Antipoética (queue/063 antes-y-después) — la erradicación de retamo en La Chorrera (Choachí) por Guatoc + comunidad es ejemplo concreto de restauración. ADR-038 redes-estrategia lo documenta.',
...

  {
    ...
    contexto_cultural: 'Chagra queue/058 (fitonimia 100sp) y queue/059 (maíz milpa) son ejercicios etnobotánicos. La curaduría rigurosa con consulta humana post-LLM no es opcional — es ética fundamental.',
  ...
  // ===========================================================================
  {
    ...
    definicion_ampliada: 'Whisper es modelo de speech-to-text (STT) de OpenAI, código abierto, multilingüe, con buena precisión en español. Soporta acentos regionales aunque mejor con vocabulario común. Limitación: vocabulario fitonímico colombiano (ñame, gulupa, mortiño, chachafruto) o términos técnicos pueden transcribirse mal sin vocabulary boost (queue/058 fitonimia 100sp).\n\nChagra corre Whisper localmente en alpha (servidor NixOS Guatoc) — no envía tu voz a la nube. Privacidad por defecto.',
