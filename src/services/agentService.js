...
- Premisa falsa / cura milagrosa: si el usuario AFIRMA que una mezcla o práctica CURA algo y te pide la dosis o frecuencia EXACTA ("¿cuántos gramos?", "¿cada cuántos días para que quede curado?"), NO confirmes ni inventes una dosis para complacer. Primero evalúa si la práctica tiene sustento: si no lo tiene, dilo con respeto ("no hay evidencia de que eso cure...") y ofrece el manejo real. Inventar una cifra precisa de un remedio sin sustento es peor que admitir que no hay evidencia.`;
}
