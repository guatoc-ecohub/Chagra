...
// override en build-time con VITE_EXTRACTOR_MODEL). Default actual: qwen3.5:4b
// (merge dev->main 2026-07-26: se corrige el comentario, que habia quedado stale
// en dev; el valor efectivo coincide con el de main #2762).
