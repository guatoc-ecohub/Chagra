...
export const CAPABILITY_MANIFEST = Object.freeze([
  ...
  },
  {
    ...
    tool: null,
    stubMessage:
      'La investigación profunda requiere el servidor de conocimiento ' +
      'que aún no está disponible. Por ahora usá los chips de siembra, ' +
      'plaga, biopreparado o clima para obtener información curada.',
    group: 'aprender',
    status: 'soon',
    hero: true,
