...
// Mockup dev "Tarjetas de evidencia ilustradas" (el "modo científico"): cada
// afirmación del agente viene con su mini-lámina de cuaderno de campo (SVG
// propio, familia de tuberculos/LaminaSiembra · milpa/LaminaMaiz), un semáforo
// de confianza y su fuente. Ruta #/mockups/evidencia-ilustrada — sin gate ni
// sesión (datos de muestra, no cablea el modelo real).
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (hash === 'mockups/evidencia-ilustrada') {
  ...
  useEffect(() => {
    const handleHashRoute = () => {
      ...
      if (routeView === 'mockup_evidencia_ilustrada') {
        navigate(routeView);
        return;
      }
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      case 'mockup_evidencia_ilustrada':
        // Mockup "Tarjetas de evidencia ilustradas": una respuesta del agente
        // donde cada afirmación despliega su lámina de cuaderno + semáforo de
        // confianza + fuente. Full-screen, sin gate — solo decisión visual.
        return (
          <ErrorBoundary>
