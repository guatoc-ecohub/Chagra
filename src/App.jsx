...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Solo precargar rutas de imagen. Un gradiente CSS no es una URL y
    // convertirlo en `new Image().src` genera un 404 que contamina los gates
    // visuales de cualquier mundo, aunque la página sí esté viva.
    if (!esGradiente(src)) {
      const img = new Image();
      img.src = src;
    }
