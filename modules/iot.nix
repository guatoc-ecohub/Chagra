...
in
{
  ...
  # influxdb_admin_token - uncomment once user adds to secrets.yaml
...
EOF
  ...
  systemd.services.podman-homeassistant.after = [ "mnt-fast.mount" ];
  systemd.services.podman-homeassistant.wants = [ "mnt-fast.mount" ];
