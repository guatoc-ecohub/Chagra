//#region ../../node_modules/@sqlite.org/sqlite-wasm/dist/index.mjs
/**
...
globalThis.sqlite3Worker1Promiser.defaultConfig = {
	worker: function() {
		return new Worker(new URL("../../../../node_modules/@sqlite.org/sqlite-wasm/dist/sqlite3-worker1.mjs", import.meta.url), { type: "module" });
	},
...
async function sqlite3InitModule(moduleArg = {}) {
	...
	*/
	...
	function findWasmBinary() {
		...
		return new URL("../../../../node_modules/@sqlite.org/sqlite-wasm/dist/sqlite3.wasm", import.meta.url).href;
	}
				...
				*/
				opfsVfs.bindVfs = function(ioMethods, callback) {
					...
					return new Promise(function(promiseResolve_, promiseReject_) {
						...
						const opfsAsyncProxyUrl = new URL("../../../../node_modules/@sqlite.org/sqlite-wasm/dist/sqlite3-opfs-async-proxy.js", import.meta.url);
