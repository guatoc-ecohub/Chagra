...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/695
- Title: [refine][catalog] brassica_oleracea_capitata_alba — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `brassica_oleracea_capitata_alba` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `brassica_oleracea_capitata_alba` (no otras species).
