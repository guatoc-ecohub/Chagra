...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/560
- Title: [refine][catalog] eucalyptus_globulus (eucalyptus_globulus) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `eucalyptus_globulus` — eucalyptus_globulus ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 143 chars (objetivo ≥200)
- `source_ids` actuales: ['humboldt-invasoras-andes', 'issg-uicn-invasoras', 'res-684-2018-mads']
...
- Notas propagación: Control de rebrote de cepa es crítico; requiere monitoreo por al menos 2 años.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "SE BUSCA: El 'Sediento de los Andes'. Seca las quebradas y envenena el suelo para que nada más crezca. Su sombra no es vida, es desierto verde."
...
- [ ] SOLO `eucalyptus_globulus` (no otras species)
