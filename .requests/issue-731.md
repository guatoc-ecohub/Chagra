...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/731
- Title: [refine][catalog] lactuca_sativa_crispa_verde — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `lactuca_sativa_crispa_verde` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `lactuca_sativa_crispa_verde` (no otras species).
