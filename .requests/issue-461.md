...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/461
- Title: [refine][catalog] brassica_oleracea_acephala_red_russian (brassica_oleracea_acephala_red_russian) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `brassica_oleracea_acephala_red_russian` — brassica_oleracea_acephala_red_russian ()
...
- Notas propagación: Sus hojas son notablemente más tiernas que las de los kales rizados; ideal para cosecha joven (baby kale).
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de respuesta lumínica: muestra cómo la planta produce pigmentos púrpuras para gestionar la radiación UV en altura."
...
- [ ] SOLO `brassica_oleracea_acephala_red_russian` (no otras species)
