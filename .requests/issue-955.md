...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/955
- Title: species-stubs: lote 5/7 (tintoreas fibras y cultivos tradicionales)
...
Foco estratégico Batch 5/7: Tintóreas, fibras y cultivos tradicionales con valor cultural

Lista de species a completar:

  1. Añil indígena (Indigofera suffruticosa Mill.) — id: indigofera_suffruticosa
  2. Jagua (Genipa americana L.) — id: genipa_americana
  3. Palo brasil (Biancaea sappan (L.) Tod.) — id: caesalpinia_sappan
  4. Carayurú (Fridericia chica (Bonpl.) L.G.Lohmann) — id: arrabidaea_chica
  5. Fique andino (Furcraea andina Trel.) — id: furcraea_andina
  6. Algodón criollo del Caribe (Gossypium barbadense L.) — id: gossypium_barbadense_criollo
  7. Cocuy (Agave cocui Trel.) — id: agave_cocui
  8. Yarumo plateado (Cecropia telealba Cuatrec.) — id: cecropia_telealba
  9. Barbasco (Deguelia utilis (A.C.Sm.) A.M.G.Azevedo) — id: lonchocarpus_velutinus
  10. Badea (Passiflora quadrangularis L.) — id: passiflora_quadrangularis
