...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/509
- Title: [refine][catalog] chenopodium_quinoa (chenopodium_quinoa) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `chenopodium_quinoa` — chenopodium_quinoa ()
...
- Notas propagación: Cosechar cuando el tallo cambie de color y el grano esté duro (no se deje rayar con la uña).
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Superalimento andino. Parte de la 'Milpa Andina'; enseña cómo obtener proteína de alta calidad sin depender de mercados externos."
...
- [ ] SOLO `chenopodium_quinoa` (no otras species)
