...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/692
- Title: [refine][catalog] calamagrostis_effusa — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `calamagrostis_effusa` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `calamagrostis_effusa` (no otras species).
