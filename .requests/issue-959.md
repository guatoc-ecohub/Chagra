...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/959
- Title: species-stubs: lote 7/7 (frutales tropicales y citricos comerciales - 6 species)
...
Foco estratégico Batch 7/7: Frutales tropicales y cítricos comerciales (6 species — último lote)

Lista de species a completar:

  1. Aguacate (Persea americana Mill.) — id: persea_americana
  2. Mango (Mangifera indica L.) — id: mangifera_indica
  3. Piña (Ananas comosus (L.) Merr.) — id: ananas_comosus
  4. Plátano (Musa × paradisiaca L.) — id: musa_paradisiaca
  5. Limón Tahití (Citrus × latifolia (Yu. Tanaka) Tanaka) — id: citrus_latifolia
  6. Naranja (Citrus × sinensis (L.) Osbeck) — id: citrus_sinensis
