...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/568
- Title: [refine][catalog] canna_edulis (canna_edulis) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `canna_edulis` — canna_edulis ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 148 chars (objetivo ≥200)
...
- Notas propagación: Propagacion por division de rizomas en epoca lluviosa. La harina de achira se usa tradicionalmente para elaborar bizcochos, coladas y pan.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Planta de usos multiples en la chagra muisca. Ensenanza de procesamiento tradicional de rizomas para harina y valor cultural del bizcocho de achira."
...
- [ ] SOLO `canna_edulis` (no otras species)
