...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/709
- Title: [refine][catalog] zea_mays — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `zea_mays` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `zea_mays` (no otras species).
