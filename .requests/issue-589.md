...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/589
- Title: [refine][catalog] hedychium_coronarium (hedychium_coronarium) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `hedychium_coronarium` — hedychium_coronarium ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 157 chars (objetivo ≥200)
- `source_ids` actuales: ['humboldt-invasoras-andes', 'res-684-2018-mads', 'powo-kew']
...
- Altitud: ?-? msnm
- Propagación principal: rizoma
- Notas propagación: Extracción TOTAL del rizoma; cualquier fragmento puede iniciar una nueva invasión rí abajo.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "SE BUSCA: La 'Invasora de Quebradas'. Sus flores huelen bien pero sus raíces matan el río. Si ves una mariposa blanca en la orilla, ¡es una alarma ecológica!"
...
- [ ] SOLO `hedychium_coronarium` (no otras species)
