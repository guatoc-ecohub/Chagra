...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/448
- Title: [refine][catalog] weinmannia_tomentosa (weinmannia_tomentosa) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `weinmannia_tomentosa` — weinmannia_tomentosa ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 117 chars (objetivo ≥200)
- `source_ids` actuales: ['humboldt-flora-alto-andina', 'sib-colombia']
...
- Notas propagación: Requiere sustrato con micorrizas del bosque nativo para prosperar.
- Estrato: medio
- Compañeros: ['alnus_acuminata', 'quercus_humboldtii']
- Antagonistas: ['eucalyptus_globulus']
- vp actual (no perder lo bueno): "Arquitecto del bosque de niebla. Sustituto ideal del eucalipto para recuperar la humedad en las quebradas de Choachí."
...
- [ ] SOLO `weinmannia_tomentosa` (no otras species)
