...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/488
- Title: [refine][catalog] sambucus_nigra_peruviana (sambucus_nigra_peruviana) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `sambucus_nigra_peruviana` — sambucus_nigra_peruviana ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 126 chars (objetivo ≥200)
- `source_ids` actuales: ['pamplona-roger-2006-plantas-medicinales', 'humboldt-flora-alto-andina']
...
- Notas propagación: Su estaca prende fácilmente, permitiendo establecer cercas funcionales en poco tiempo.
- Estrato: alto
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Farmacia viva chiguana. Sus flores y frutos no solo atraen aves, sino que son fundamentales en la medicina tradicional andina."
...
- [ ] SOLO `sambucus_nigra_peruviana` (no otras species)
