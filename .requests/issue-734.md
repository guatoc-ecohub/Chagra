...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/734
- Title: [refine][catalog] sambucus_nigra_peruviana — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `sambucus_nigra_peruviana` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `sambucus_nigra_peruviana` (no otras species).
