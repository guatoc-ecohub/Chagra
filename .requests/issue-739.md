...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/739
- Title: [refine][catalog] brassica_oleracea_acephala_curly — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `brassica_oleracea_acephala_curly` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `brassica_oleracea_acephala_curly` (no otras species).

Coherente con thermal_zones y altitud_msnm existentes. NO inventar.

🤖 Batch slim wave 3. Generated with [Claude Code](https://claude.com/claude-code)
