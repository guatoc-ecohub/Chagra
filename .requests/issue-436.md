...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/436
- Title: [refine][catalog] beta_vulgaris_cicla_blanca (beta_vulgaris_cicla_blanca) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `beta_vulgaris_cicla_blanca` — beta_vulgaris_cicla_blanca ()

Estado actual en `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 113 chars (objetivo ≥200)
...
- Notas propagación: Variedad clásica más rústica y productiva; tolera bien los cortes frecuentes.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (para no perder lo bueno que ya hay): "La variedad estándar de mayor productividad; ideal para enseñar el manejo de biomasa foliar y cortes sostenibles."
...
- [ ] NO alterar otras species (solo `beta_vulgaris_cicla_blanca`)

RESTRICCIONES:
- SOLO modificar `beta_vulgaris_cicla_blanca` (no otras species)
- NO inventar datos sin fuente
- NO Wikipedia única
- NO platitudes

Prioridad P1. Batch refinamiento producción (batch 2 — top-10 de 10).
