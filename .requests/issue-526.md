...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/526
- Title: [refine][catalog] origanum_vulgare (origanum_vulgare) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `origanum_vulgare` — origanum_vulgare ()
...
- Notas propagación: Propagación fácil por estacas de tallo o división de mata en época de lluvias.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Lección de rusticidad y sabor mediterráneo adaptado: muestra cómo una planta puede ser cobertura de suelo y botica al mismo tiempo."
...
- [ ] SOLO `origanum_vulgare` (no otras species)
