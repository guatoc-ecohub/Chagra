...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/954
- Title: species-stubs: lote 4/7 (aromaticas condimentarias y frutales templados-calidos)
...
Foco estratégico Batch 4/7: Aromáticas, condimentarias y frutales templados-cálidos

Lista de species a completar:

  1. Albahaca (Ocimum basilicum L.) — id: ocimum_basilicum
  2. Berro de agua (Nasturtium officinale W.T.Aiton) — id: nasturtium_officinale
  3. Totumo (Crescentia cujete L.) — id: crescentia_cujete
  4. Chaya (Cnidoscolus aconitifolius (Mill.) I.M.Johnst.) — id: cnidoscolus_aconitifolius
  5. Achiote (Bixa orellana L.) — id: bixa_orellana
  6. Pitahaya amarilla (Selenicereus megalanthus (K.Schum. ex Vaupel) Moran) — id: selenicereus_megalanthus
  7. Pepino dulce (Solanum muricatum Aiton) — id: solanum_muricatum
  8. Tomatillo verde (Physalis philadelphica Lam.) — id: physalis_philadelphica
  9. Tomate de árbol naranja (Solanum betaceum Cav. (cultivar naranja-amarillo)) — id: solanum_betaceum_naranja
  10. Tomate de árbol morado (Solanum betaceum Cav. (cultivar morado-antocianínico)) — id: solanum_betaceum_morado
