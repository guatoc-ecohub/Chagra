...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/541
- Title: [refine][catalog] brassica_oleracea_sabauda (brassica_oleracea_sabauda) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `brassica_oleracea_sabauda` — brassica_oleracea_sabauda ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 137 chars (objetivo ≥200)
...
- vp actual: "Lección de selección varietal: su textura rugosa es un aislante térmico natural que le permite resistir inviernos intensos en la montaña."
...
- [ ] SOLO `brassica_oleracea_sabauda` (no otras species)
