...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/574
- Title: [refine][catalog] pinus_patula (pinus_patula) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `pinus_patula` — pinus_patula ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 150 chars (objetivo ≥200)
- `source_ids` actuales: ['calderon-saenz-2003-invasoras', 'gbif-taxonomic-backbone']
...
- Notas propagación: Las acículas acidifican el suelo; requiere limpieza de sitio post-tala.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "SE BUSCA: El 'Acidificador'. Alfombra el suelo con sus agujas para que el roble andino no pueda nacer. Su lugar debe ser devuelto al bosque de niebla."
...
- [ ] SOLO `pinus_patula` (no otras species)
