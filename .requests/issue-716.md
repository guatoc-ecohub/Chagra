...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/716
- Title: [refine][catalog] raphanus_sativus — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `raphanus_sativus` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `raphanus_sativus` (no otras species).
