...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/499
- Title: [refine][catalog] vaccinium_corymbosum_emerald (vaccinium_corymbosum_emerald) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `vaccinium_corymbosum_emerald` — vaccinium_corymbosum_emerald ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 128 chars (objetivo ≥200)
- `source_ids` actuales: ['agrosavia-manual-arandano-2018', 'powo-kew']
...
- Notas propagación: Variedad vigorosa con baja necesidad de frío (low-chill); ideal para las etapas de transición climática en Choachí.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de precocidad: variedad que permite entender la importancia de la adaptación climática y la ventana de cosecha temprana."
...
- [ ] SOLO `vaccinium_corymbosum_emerald` (no otras species)
