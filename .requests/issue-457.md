...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/457
- Title: [refine][catalog] tropaeolum_tuberosum (tropaeolum_tuberosum) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `tropaeolum_tuberosum` — tropaeolum_tuberosum ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 121 chars (objetivo ≥200)
- `source_ids` actuales: ['agrosavia-manual-tuberculos-andinos-2017', 'cip-potatoes-americas']
...
- Notas propagación: Posee propiedades nematicidas naturales; excelente para rotar terrenos tras la siembra de papa.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Soberanía alimentaria chiguana. Un tubérculo ultra-resistente que limpia el suelo de nematodos para las futuras siembras."
...
- [ ] SOLO `tropaeolum_tuberosum` (no otras species)
