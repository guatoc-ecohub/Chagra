...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/502
- Title: [refine][catalog] apium_graveolens (apium_graveolens) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `apium_graveolens` — apium_graveolens ()
...
- Notas propagación: Requiere semillero y trasplante muy cuidadoso por tener una raíz extremadamente sensible.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de nutrición hídrica: el apio demuestra la importancia de la humedad constante para evitar tallos fibrosos en la montaña."
...
- [ ] SOLO `apium_graveolens` (no otras species)
