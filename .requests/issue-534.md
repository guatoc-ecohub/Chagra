...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/534
- Title: [refine][catalog] fragaria_ananassa_monterrey (fragaria_ananassa_monterrey) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `fragaria_ananassa_monterrey` — fragaria_ananassa_monterrey ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 135 chars (objetivo ≥200)
...
- Altitud: ?-? msnm
- Propagación principal: estolon
- Notas propagación: Variedad de día neutro; requiere acolchado (mulch) de paja o plástico para evitar que el fruto toque el suelo y se pudra.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Lección de fotoperiodo: variedad que permite entender cómo la planta produce flores y frutos independientemente de la duración del día."
...
- [ ] SOLO `fragaria_ananassa_monterrey` (no otras species)
