...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/425
- Title: [refine][catalog] lactuca_sativa_longifolia_verde (lactuca_sativa_longifolia_verde) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `lactuca_sativa_longifolia_verde` — lactuca_sativa_longifolia_verde ()

Estado actual en `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 98 chars (objetivo ≥200)
...
- Notas propagación: Cosecha de planta entera entre los 65-80 días, cuando la cabeza está firme y las hojas internas blanqueadas.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (para no perder lo bueno que ya hay): "Variedad acogollada permite enseñar el blanqueamiento natural por autosombreado de hojas internas."
...
- [ ] NO alterar otras species (solo `lactuca_sativa_longifolia_verde`)

RESTRICCIONES:
- SOLO modificar `lactuca_sativa_longifolia_verde` (no otras species)
- NO inventar datos sin fuente
- NO Wikipedia única
- NO platitudes

Prioridad P1. Batch refinamiento producción (batch 2 — top-1 de 10).
