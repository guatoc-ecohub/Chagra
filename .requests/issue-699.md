...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/699
- Title: [refine][catalog] ullucus_tuberosus — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `ullucus_tuberosus` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `ullucus_tuberosus` (no otras species).
