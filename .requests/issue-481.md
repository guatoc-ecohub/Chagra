...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/481
- Title: [refine][catalog] solanum_betaceum (solanum_betaceum) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `solanum_betaceum` — solanum_betaceum ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 125 chars (objetivo ≥200)
- `source_ids` actuales: ['agrosavia-manual-uchuva-2015', 'gbif-taxonomic-backbone']
...
- Notas propagación: Planta de rápido crecimiento pero vida corta (6-8 años); sensible al ataque de nematodos y exceso de humedad.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Frutal andino por excelencia. Su sombra ligera puede servir como nodriza para cultivos de estrato bajo en la chagra chiguana."
...
- [ ] SOLO `solanum_betaceum` (no otras species)
