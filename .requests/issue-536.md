...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/536
- Title: [refine][catalog] rosmarinus_officinalis (rosmarinus_officinalis) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `rosmarinus_officinalis` — rosmarinus_officinalis ()
...
- Notas propagación: Se recomienda el uso de hormonas de enraizamiento naturales (como agua de lentejas).
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Lección de rusticidad: ejemplifica la capacidad de algunas especies para prosperar en suelos pobres y climas extremos de la cordillera."
...
- [ ] SOLO `rosmarinus_officinalis` (no otras species)
