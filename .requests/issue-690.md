...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/690
- Title: [refine][catalog] passiflora_edulis_flavicarpa — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `passiflora_edulis_flavicarpa` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `passiflora_edulis_flavicarpa` (no otras species).
