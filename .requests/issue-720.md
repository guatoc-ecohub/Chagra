...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/720
- Title: [refine][catalog] allium_sativum — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `allium_sativum` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `allium_sativum` (no otras species).
