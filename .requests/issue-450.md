...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/450
- Title: [refine][catalog] brassica_oleracea_capitata_alba (brassica_oleracea_capitata_alba) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `brassica_oleracea_capitata_alba` — brassica_oleracea_capitata_alba ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 119 chars (objetivo ≥200)
...
- Notas propagación: Requiere semillero. El trasplante debe ser profundo para asegurar estabilidad.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de morfología: muestra cómo las hojas se envuelven y compactan para formar una 'cabeza' protegida en la chagra."
...
- [ ] SOLO `brassica_oleracea_capitata_alba` (no otras species)
