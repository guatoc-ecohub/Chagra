...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/462
- Title: [refine][catalog] allium_cepa (allium_cepa) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `allium_cepa` — allium_cepa ()
...
- Notas propagación: En la chagra chiguana se prefiere la siembra por bulbitos (cebollín de siembra) para acelerar el ciclo.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de estratificación: enseña cómo la planta acumula reservas en capas (túnicas) para sobrevivir a periodos adversos."
...
- [ ] SOLO `allium_cepa` (no otras species)
