...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/552
- Title: [refine][catalog] rubus_glaucus_sin_espinas (rubus_glaucus_sin_espinas) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `rubus_glaucus_sin_espinas` — rubus_glaucus_sin_espinas ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 140 chars (objetivo ≥200)
- `source_ids` actuales: ['nrc-1989-cultivos-andinos', 'agrosavia-leguminosas-andinas', 'gbif-taxonomic-backbone', 'ica-resolucion-3168-2015']
...
- Altitud: ?-? msnm
- Propagación principal: acodo
- Notas propagación: Variedad seleccionada para facilitar la poda y cosecha sin las espinas tradicionales; requiere tutorado en espaldera.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Lección de domesticación: muestra las ventajas de la selección varietal para mejorar la ergonomía y la seguridad en la agricultura familiar."
...
- [ ] SOLO `rubus_glaucus_sin_espinas` (no otras species)
