...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/730
- Title: [refine][catalog] solanum_betaceum — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `solanum_betaceum` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `solanum_betaceum` (no otras species).
