...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/591
- Title: [refine][catalog] rubus_alceifolius (rubus_alceifolius) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `rubus_alceifolius` — rubus_alceifolius ()
...
- Notas propagación: Crecimiento extremadamente vigoroso; forma túneles que entierran a las especies nativas.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "SE BUSCA: El 'Matorral Asfixiante'. Una mora gigante de Asia que no permite el paso ni de la luz ni de los chiguanos. Se cambia por nuestra Mora de Castilla."
...
- [ ] SOLO `rubus_alceifolius` (no otras species)
