...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/451
- Title: [refine][catalog] allium_ampeloprasum (allium_ampeloprasum) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `allium_ampeloprasum` — allium_ampeloprasum ()
...
- Notas propagación: Requiere trasplante profundo para favorecer el 'blanqueado' del tallo.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de aporque: enseña cómo el manejo del suelo (blanqueo) afecta las propiedades culinarias del tallo en la chagra."
...
- [ ] SOLO `allium_ampeloprasum` (no otras species)
