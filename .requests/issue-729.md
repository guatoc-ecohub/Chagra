...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/729
- Title: [refine][catalog] passiflora_ligularis — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `passiflora_ligularis` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `passiflora_ligularis` (no otras species).
