...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/544
- Title: [refine][catalog] lupinus_mutabilis (lupinus_mutabilis) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `lupinus_mutabilis` — lupinus_mutabilis ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 139 chars (objetivo ≥200)
- `source_ids` actuales: ['agrosavia-manual-biopreparados-2015', 'cip-2006-ghislain']
...
- Notas propagación: Sus raíces son fijadoras masivas de nitrógeno; excelente abono verde si se incorpora antes de florecer.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Leguminosa de alta montaña. Sus alcaloides actúan como repelentes naturales en la chagra; enseña el valor de los cultivos de ciclo cerrado."
...
- [ ] SOLO `lupinus_mutabilis` (no otras species)
