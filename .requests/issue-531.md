...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/531
- Title: [refine][catalog] smallanthus_sonchifolius (smallanthus_sonchifolius) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `smallanthus_sonchifolius` — smallanthus_sonchifolius ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 134 chars (objetivo ≥200)
- `source_ids` actuales: ['agrosavia-manual-tuberculos-andinos-2017', 'perez-arbelaez-1947-plantas-utiles']
...
- Notas propagación: Se propaga por secciones de corona con yemas. Las raices tuberosas acumulan fructooligosacaridos (FOS), ideales para diabeticos.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Tuberculo functional de la chagra. Ensenanza de nutricion y salud: FOS como alternativa deendulzante natural para la dieta altoandina."
...
- [ ] SOLO `smallanthus_sonchifolius` (no otras species)
