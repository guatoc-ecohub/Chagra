...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/445
- Title: [refine][catalog] passiflora_edulis_flavicarpa (passiflora_edulis_flavicarpa) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `passiflora_edulis_flavicarpa` — passiflora_edulis_flavicarpa ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 115 chars (objetivo ≥200)
...
- Notas propagación: Polinización manual a menudo necesaria para alta producción; muy sensible al frío.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de gradiente térmico: contraste de requerimientos calurosos frente a sus parientes andinos (gulupa/curuba)."
...
- [ ] SOLO `passiflora_edulis_flavicarpa` (no otras species)
