...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/467
- Title: [refine][catalog] lactuca_sativa_roble_morada (lactuca_sativa_roble_morada) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `lactuca_sativa_roble_morada` — lactuca_sativa_roble_morada ()
...
- Notas propagación: Variedades pigmentadas suelen tener termodormancia más marcada; sembrar en lotes con buena ventilación nocturna.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Las antocianinas responden al fotoperíodo y la temperatura: ideal para enseñar respuestas fisiológicas al ambiente andino."
...
- [ ] SOLO `lactuca_sativa_roble_morada` (no otras species)
