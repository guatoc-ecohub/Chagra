...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/452
- Title: [refine][catalog] salvia_officinalis (salvia_officinalis) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `salvia_officinalis` — salvia_officinalis ()
...
- Notas propagación: Los esquejes semileñosos enraízan con facilidad; prefiere suelos ligeros.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de adaptación hídrica: sus hojas vellosas muestran una estrategia para reducir la transpiración en climas secos."
...
- [ ] SOLO `salvia_officinalis` (no otras species)
