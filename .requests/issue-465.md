...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/465
- Title: [refine][catalog] coffea_arabica (coffea_arabica) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `coffea_arabica` — coffea_arabica ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 122 chars (objetivo ≥200)
- `source_ids` actuales: ['cenicafe-manual-cafetero-2013', 'gbif-taxonomic-backbone', 'ica-resolucion-3168-2015']
...
- Thermal zones: ['templado']
- Altitud: ?-? msnm
- Propagación principal: semilla
- Notas propagación: Requiere germinador en arena y posterior embolsado.
- Estrato: medio
- Compañeros: ['alnus_acuminata']
- Antagonistas: ['foeniculum_vulgare']
- vp actual (no perder lo bueno): "Lección de selección varietal: comparación de resistencia a Hemileia vastatrix entre variedades tradicionales y mejoradas."
...
- [ ] SOLO `coffea_arabica` (no otras species)
