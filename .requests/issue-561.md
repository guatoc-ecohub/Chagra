...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/561
- Title: [refine][catalog] erythrina_rubrinervia (erythrina_rubrinervia) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `erythrina_rubrinervia` — erythrina_rubrinervia ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 145 chars (objetivo ≥200)
- `source_ids` actuales: ['perez-arbelaez-1947-plantas-utiles', 'gbif-taxonomic-backbone', 'bernal-2015-plantas-liquenes-colombia']
...
- Notas propagación: Arbol de la familia Fabaceae, fijador de N. Sus flores rojas son fuente de nectar para colibries y abejas nativas. Madera blanda usada para postes y artesania.
- Estrato: alto
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Cerca viva florecida: cuando florece el chilo, las abejas llegan. Ensenia el rol de las leguminosas en la fertilidad del suelo y la polinizacion."
...
- [ ] SOLO `erythrina_rubrinervia` (no otras species)
