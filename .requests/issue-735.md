...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/735
- Title: [refine][catalog] rubus_idaeus_golden — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `rubus_idaeus_golden` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `rubus_idaeus_golden` (no otras species).
