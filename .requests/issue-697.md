...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/697
- Title: [refine][catalog] salvia_officinalis — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `salvia_officinalis` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `salvia_officinalis` (no otras species).
