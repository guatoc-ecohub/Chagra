...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/510
- Title: [refine][catalog] solanum_lycopersicum_cerasiforme (solanum_lycopersicum_cerasiforme) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `solanum_lycopersicum_cerasiforme` — solanum_lycopersicum_cerasiforme ()
...
- Notas propagación: Crecimiento indeterminado; requiere tutorado (colgado) y podas frecuentes de chupones.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de cosecha escalonada: enseña cómo los frutos maduran en racimos de forma secuencial, permitiendo una provisión constante."
...
- [ ] SOLO `solanum_lycopersicum_cerasiforme` (no otras species)
