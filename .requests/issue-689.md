...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/689
- Title: [refine][catalog] beta_vulgaris_cicla_blanca — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `beta_vulgaris_cicla_blanca` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `beta_vulgaris_cicla_blanca` (no otras species).
