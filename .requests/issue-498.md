...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/498
- Title: [refine][catalog] physalis_peruviana (physalis_peruviana) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `physalis_peruviana` — physalis_peruviana ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 128 chars (objetivo ≥200)
- `source_ids` actuales: ['agrosavia-manual-uchuva-2015', 'powo-kew']
...
- Notas propagación: Planta perenne de corta vida (2-3 años productivos); requiere tutorado para facilitar la cosecha y evitar hongos por humedad.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "La joya protegida: su capacho natural enseña la importancia de la protección post-cosecha y la conservación del valor nutritivo."
...
- [ ] SOLO `physalis_peruviana` (no otras species)
