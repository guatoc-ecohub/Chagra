...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/714
- Title: [refine][catalog] coffea_arabica — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `coffea_arabica` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `coffea_arabica` (no otras species).
