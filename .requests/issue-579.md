...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/579
- Title: [refine][catalog] brassica_oleracea_var_acephala (brassica_oleracea_var_acephala) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `brassica_oleracea_var_acephala` — brassica_oleracea_var_acephala ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 152 chars (objetivo ≥200)
...
- Notas propagación: Siembra escalonada cada 4-6 semanas para cosecha continua. Las heladas mejoran el sabor al convertir almidones en azucares.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Leccion de resiliencia al frio: el kale endulza con las heladas, ensenando como el estres termico transforma la quimica de la planta en la alta montana."
...
- [ ] SOLO `brassica_oleracea_var_acephala` (no otras species)
