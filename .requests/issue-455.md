...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/455
- Title: [refine][catalog] zea_mays (zea_mays) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `zea_mays` — zea_mays ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 120 chars (objetivo ≥200)
- `source_ids` actuales: ['agrosavia-manual-biopreparados-2015', 'gbif-taxonomic-backbone', 'ica-resolucion-3168-2015']
...
- Notas propagación: Siembra directa en sitio definitivo.
- Estrato: alto
- Compañeros: ['chenopodium_quinoa', 'lupinus_mutabilis', 'phaseolus_vulgaris', 'solanum_phureja', 'trifolium_repens', 'vicia_sativa']
- Antagonistas: ['foeniculum_vulgare']
- vp actual (no perder lo bueno): "Lección de Milpa: enseña el sistema de 'las tres hermanas' y la importancia de la diversidad genética en razas criollas."
...
- [ ] SOLO `zea_mays` (no otras species)
