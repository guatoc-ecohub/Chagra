...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/477
- Title: [refine][catalog] lactuca_sativa_crispa_verde (lactuca_sativa_crispa_verde) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `lactuca_sativa_crispa_verde` — lactuca_sativa_crispa_verde ()
...
- Notas propagación: Termodormancia marcada: semillas no germinan sobre 25°C; sembrar en horas frescas.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Hortaliza emblemática de huertos urbanos y rurales por su rápido ciclo, rebrote tras corte y bajo requerimiento de espacio."
...
- [ ] SOLO `lactuca_sativa_crispa_verde` (no otras species)
