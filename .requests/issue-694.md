...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/694
- Title: [refine][catalog] erythrina_edulis — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `erythrina_edulis` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `erythrina_edulis` (no otras species).
