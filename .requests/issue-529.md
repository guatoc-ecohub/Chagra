...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/529
- Title: [refine][catalog] dioscorea_trifida (dioscorea_trifida) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `dioscorea_trifida` — dioscorea_trifida ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 132 chars (objetivo ≥200)
...
- Notas propagación: Propagacion por secciones de tuberculo con yemas o por bulbillos aereos. Requiere sustrato suelto y profundo.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual: "Name andino tradicional del sistema chagra muisca. Ensenanza de raices reservantes y propagacion vegetativa en la huerta altoandina."
...
- [ ] SOLO `dioscorea_trifida` (no otras species)
