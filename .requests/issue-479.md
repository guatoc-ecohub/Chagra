...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/479
- Title: [refine][catalog] passiflora_ligularis (passiflora_ligularis) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `passiflora_ligularis` — passiflora_ligularis ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 124 chars (objetivo ≥200)
- `source_ids` actuales: ['gbif-taxonomic-backbone', 'fao-ecocrop', 'powo-kew']
...
- Notas propagación: Requiere estructuras de soporte (espalderas o emparrillados); sensible a heladas.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de entomología: importancia de los abejorros (Xylocopa spp.) para la polinización efectiva y el éxito de la cosecha."
...
- [ ] SOLO `passiflora_ligularis` (no otras species)
