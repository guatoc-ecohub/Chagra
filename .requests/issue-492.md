...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/492
- Title: [refine][catalog] brassica_oleracea_acephala_curly (brassica_oleracea_acephala_curly) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `brassica_oleracea_acephala_curly` — brassica_oleracea_acephala_curly ()
...
- Notas propagación: Se recomienda sembrar escalonadamente; extremadamente resistente a la manipulación.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de hortaliza perenne: permite entender el concepto de plantas multianuales y su resistencia a la escarcha en el huerto."
...
- [ ] SOLO `brassica_oleracea_acephala_curly` (no otras species)
