...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/487
- Title: [refine][catalog] rubus_idaeus_golden (rubus_idaeus_golden) — vp ≥200 chars + Tier A sources
...
**SPECIES EXISTENTE A REFINAR:** `rubus_idaeus_golden` — rubus_idaeus_golden ()

Estado actual `catalog/chagra-catalog-seed-v3.1.json`:
- `valor_pedagogico` actual: 126 chars (objetivo ≥200)
- `source_ids` actuales: ['powo-kew', 'gbif-taxonomic-backbone']
...
- Notas propagación: Crecimiento menos vigoroso que la roja pero frutos notablemente más dulces; requiere suelos muy bien drenados y ricos en potasio.
- Estrato: no registrado
- Compañeros: no registrado
- Antagonistas: no registrado
- vp actual (no perder lo bueno): "Lección de pigmentos: comparación entre antocianinas y su ausencia, y su impacto en el sabor y las propiedades organolépticas."
...
- [ ] SOLO `rubus_idaeus_golden` (no otras species)
