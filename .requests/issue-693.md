...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/693
- Title: [refine][catalog] weinmannia_tomentosa — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `weinmannia_tomentosa` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `weinmannia_tomentosa` (no otras species).
