...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/711
- Title: [refine][catalog] tropaeolum_tuberosum — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `tropaeolum_tuberosum` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `tropaeolum_tuberosum` (no otras species).
