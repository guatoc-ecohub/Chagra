...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/732
- Title: [refine][catalog] rubus_idaeus_heritage — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `rubus_idaeus_heritage` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `rubus_idaeus_heritage` (no otras species).
