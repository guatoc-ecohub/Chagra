...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/737
- Title: [refine][catalog] beta_vulgaris_cicla_roja — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `beta_vulgaris_cicla_roja` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `beta_vulgaris_cicla_roja` (no otras species).
