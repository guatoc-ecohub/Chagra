...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/718
- Title: [refine][catalog] lens_culinaris_andina — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `lens_culinaris_andina` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `lens_culinaris_andina` (no otras species).
