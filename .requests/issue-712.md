...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/712
- Title: [refine][catalog] allium_cepa — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `allium_cepa` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `allium_cepa` (no otras species).
