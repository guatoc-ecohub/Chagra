...
- Issue: https://github.com/guatoc-ecohub/Chagra/issues/696
- Title: [refine][catalog] allium_ampeloprasum — vp ≥200 chars + Tier A sources
- Author: @guatoc-ecohub
- Status: awaiting code-generation

## Body

Refinar `allium_ampeloprasum` en `catalog/chagra-catalog-seed-v3.1.json`:
...
3. SOLO modificar `allium_ampeloprasum` (no otras species).
