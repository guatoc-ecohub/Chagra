...
/* Los estados conversacionales. A los cinco de siempre (idle/thinking/
   speaking/listening/caminando) se suman los SEIS de la base de Angelita
   (contenta/preocupada/no-se/senala/invita/husmea): así el comparador ejercita
   que el jaguar, el oso y el chivito llegaron a >= la base de Angelita. Cada
   compai los actúa con su anatomia (ver *Lamina.css); los que aún no tienen
   par de lámina degradan al idle sin romperse. */
const ESTADOS = [
  'idle', 'thinking', 'speaking', 'listening',
  'contenta', 'preocupada', 'no-se', 'senala', 'invita', 'husmea',
  'caminando',
];
...
const ELENCO = [
  {
    slug: 'jaguar', nombre: 'Taita Jaguar', emoji: '🐆',
  ...
  {
    slug: 'oso', nombre: 'Oso Protector', emoji: '🐻',
